...
#define ADE9000_ACCMODE 0x0000			/*50Hz operation, 3P4W Wye configuration, signed accumulation*/
...
class ADE9000Class
{
	public:
		...
		/*SPI Functions*/
		void SPI_Init(uint32_t SPI_speed , uint8_t chipSelect_Pin, int8_t sck = -1, int8_t miso = -1, int8_t mosi = -1);  		
