...
void ADE9000Class::SPI_Init(uint32_t SPI_speed , uint8_t chipSelect_Pin, int8_t sck, int8_t miso, int8_t mosi)
{
	SPI.begin(sck, miso, mosi, chipSelect_Pin);		//Initiate SPI port
